...
function PrivacyNotice() {
  return (
    <Section>
      ...
      <SectionDivider />
      <SectionText>
        Immunitas Security collects and processes personal data via the www.immunitas.uk website (“Website”). This privacy notice is designed to inform you about the data we collect, what we use it for and your rights regarding the use of this data.
      </SectionText>
      ...
      <SectionText>
        Immunitas provides cyber security services to a wide range of organisations. We are committed to protecting the personal data we hold.
      </SectionText>

      <SectionSubTitle>Why Do We Collect & Process Personal Data?</SectionSubTitle>

      <SectionText>
        We collect personal data to offer and administer our services and products. The data you provide to us will be processed in accordance with the purposes specified in this notice, namely:
        <ul>
          ...
          <br />
          <li>
            For improving our communications with you. Emails sent to you by us may include standard tracking, including open and click activities. Redscan may collect information about your activity as you interact with our email messages and related content.
          </li>
          <br />
          <li>
            For security purposes. For example, we may use your data to protect us and our third parties against security breaches and to prevent fraud and violation our applicable agreements (where the processing is necessary for our legitimate business interests).
          </li>
          <br />
          <li>
      ...
      <SectionText>
        ...
        <ul>
          ...
          <li>IP Address, Browser ID & Communication Preferences</li>
        </ul>
      ...
      <SectionText>
        Personal data is processed both manually and electronically in accordance with the above-mentioned purposes and in compliance with current regulations. We permit only authorized employees and Third-Party processors to have access to your information. Such employees and Third-Party processors are appropriately designated and trained to process data only according to the instructions we provide them.
      </SectionText>

      <SectionSubTitle>
        Storage Of Personal Data & Retention Period
      </SectionSubTitle>
      <SectionText>
        We will process and store your personal data only as long as necessary to fulfil the purpose that the data was collected for, taking into account legitimate business needs to capture and retain such information. Information will also be retained for a period necessary to comply with state, local, federal regulations, or country specific regulations and requirements, and in accordance with our Document Retention Schedule.
      </SectionText>
      ...
      <SectionText>
        To help process your personal data for the purposes described in this policy, We may entrust third party processers (“Third Parties”) or share data among Our affiliates who act for us for the purposes set out in this notice.
        <br />
        We have contractual agreements in place with all the contracted Third Parties we work with in order to ensure your personal data is used only for the provision of the contracted services and in a manner that is consistent with this policy. Examples of Third Parties include CRM and marketing automation providers.
        <br />
        ...
        <ul>
          <li>Ensuring the country is the subject of an EU adequacy decision</li>
          <li>Ensuring transfers are governed by the requirements of the Standard Contractual Clauses adopted by the European Commission or by another adequate transfer mechanism.</li>
        </ul>
        <br />
      ...
      <SectionText>
        ...
        <br />
        <ul>
          <li>Right of access – you have the right to access the personal information that we hold about you.</li>
          ...
          <li>Right to judicial review: in the event that we refuse your request under rights of access, we will provide you with a reason as to why. You have the right to complain (as outlined in the Complaints section below).</li>
        </ul>
        <br />
      ...
      <SectionText>
        ...
        <br />
        Immunitas does not make automated decisions using personal data. If automated decisions are to be made, affected persons will be given an opportunity to express their views on the automated decision in question and object to it.
      </SectionText>

      <SectionSubTitle>
        Providing Information To Immunitas
      </SectionSubTitle>
      <SectionText>
      ...
      <SectionText>
        We are not responsible for the privacy practices of any non-Redscan operated websites, mobile apps or other digital services, including those that may be linked through our websites or services, and we encourage you to review the privacy policies or notices published thereon.
      </SectionText>
      ...
      <SectionText>
        From time to time, We may update this privacy notice to reflect changes to the personal data we process or for other operational, legal or regulatory reasons.
      ...
      <SectionText>
        In the event that you wish to make a complaint about how your personal data is processed by Immunitas, please email us at dataprotection@immunitas.uk
        <br />
        If you unhappy about how a complaint has been handled by Immunitas, you have a right to lodge a complaint directly with the Information Commissioner’s office in the UK (www.ico.org.uk) or your local supervisory authority.
      </SectionText>
