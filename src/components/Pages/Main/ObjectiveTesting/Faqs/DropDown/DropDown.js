...
import { FaChevronRight, FaPlusCircle, FaArrowAltCircleDown, FaCaretDown } from "react-icons/fa";
    ...
    < Grid >
      ...
      <Menu>
        <>
          <Menu.Button>
            <FaqTitle className="">
              <FaCaretDown className="inline pr-3 h-10 w-10 pb-2" aria-hidden="true" color='#BF5249' />
